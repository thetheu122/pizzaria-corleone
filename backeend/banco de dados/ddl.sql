...
INSERT INTO tb_produto ( ds_tipo_produto , ds_comentario , nm_produto , vl_preco , ds_descricao , vl_preco_promocional , bt_disponivel) 
                VALUES ( 1 , 1 , 'Pizza de chocolate' , '71,00' , ' pizza de chocolate com chocolate ' ,'30' , true);
...
SET
    ...
    tb_comentario.ds_comentario = 'Novo Comentário',
